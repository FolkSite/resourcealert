<?php
/**
* Connector file for resourcealert extra
*
...
$resourcealertCorePath = $modx->getOption('resourcealert.core_path', null, $modx->getOption('core_path') . 'components/resourcealert/');
require_once $resourcealertCorePath . 'model/resourcealert/resourcealert.class.php';
$modx->resourcealert = new resourcealert($modx);

$modx->lexicon->load('resourcealert:default');

/* handle request */
$path = $modx->getOption('processorsPath', $modx->resourcealert->config, $resourcealertCorePath . 'processors/');
