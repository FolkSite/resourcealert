<?php
/**
* Resolver to connect Property Sets to Elements for resourcealert extra
*
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        $intersects = array (
                0 =>  array (
                  ...
                  'property_set' => 'ResourceAlertProps',
                ),
                1 =>  array (
                  'element' => 'ResourceAlertSnippet',
                  'element_class' => 'modSnippet',
                  'property_set' => 'ResourceAlertProps',
                ),
                2 =>  array (
                  'element' => 'ResourceAlertPlugin',
                  'element_class' => 'modPlugin',
                  'property_set' => 'ResourceAlertProps',
                ),
                3 =>  array (
                  'element' => 'ResourceAlertTogglerButton',
                  'element_class' => 'modChunk',
                  'property_set' => 'ResourceAlertProps',
                ),
                4 =>  array (
                  'element' => 'ResourceAlertable',
