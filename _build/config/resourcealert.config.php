...
$packageNameLower = 'resourcealert'; /* No spaces, no dashes */

$components = array(
    /* These are used to define the package and set values for placeholders */
    'packageName' => 'resourcealert',  /* No spaces, no dashes */
    'packageNameLower' => $packageNameLower,
    'packageDescription' => 'Subscription type alerts for frontend users when resources are updated in CMS (subscribe to page update emails).',
    'version' => '1.0.8',
    'release' => 'beta1',
    ...
    'packageDocumentationUrl' => 'http://stuntrocket.co/modx/resourcealert.html',
    'copyright' => '2016',
    ...
    'gitHubRepository' => 'resourcealert',
    ...
    'newSystemSettings' => array(
        'resourcealert_enabled' => array( // key
    ...
    */
    ...
    'namespaces' => array(
        'resourcealert' => array(
            'name' => 'resourcealert',
            'path' => '{core_path}components/resourcealert/',
            'assets_path' => '{assets_path}components/resourcealert/',
        ),
    ...
    */
    ...
    'categories' => array(
        'ResourceAlert' => array(
            'category' => 'ResourceAlert',
            'parent' => '',  /* top level category */
        )
        /* ,
        'category2' => array(
            'category' => 'Category2',
            'parent' => 'ResourceAlert',
        )
        */
    ),
    ...
    */
    'elements' => array(
        ...
        'snippets' => array(
            ...
            'ResourceAlertSnippet' => array( /* resourcealert with static and property set(s)  */
                'category' => 'ResourceAlert',
        ...
        'plugins' => array(
            'ResourceAlertPlugin' => array( /* resourcealert with static, events, and property sets */
                'category' => 'ResourceAlert',
        ...
        'chunks' => array(
            'ResourceAlertTogglerButton' => array(
        ...
        'templates' => array(
            /* 'ResourceAlert2' => array(
                'category' => 'ResourceAlert',
                'description' => 'Description for Template ResourceAlert',
                'static' => false,
                'propertySets' => array(
                  'CCEmail',
                  'CCName'
        ...
        'templateVars' => array(
            ...
            'AlertSummary' => array( /* resourcealert with templates, default, and static specified */
                'category' => 'ResourceAlert',
    ...
    'resources' => array(
      /* 
        'ResourceAlertList' => array(
            'pagetitle' => 'Resource Alert List',
            'alias' => 'resource-alert-list',
            'category' => 'ResourceAlert',
            'context_key' => 'web',
            'richtext' => false,
            'published' => false,
        ...
        */
        /* 'ResourceAlertList2' => array(
            'pagetitle' => 'Resource Alert List 2',
            'alias' => 'resource-alert-list-2',
            'context_key' => 'web',
            'parent' => 'ResourceAlertList',
            'template' => 'ResourceAlert2',
            'richtext' => false,
            'published' => true,
            'tvValues' => array(
                'ResourceAlertable' => 'No',
                'ResourceAlertSummary' => 'Test',
            ),
        ), */
    ),
    ...
    */
    ...
    'classes' => array(
        'ResourceAlert' => 'resourcealert:resourcealert',
        ...
        'ResourcealertItem' => 'resourcealert:resourcealertitem',
        'ResourcealertAlert' => 'resourcealert:resourcealertalert',
    ),
    /* ************************************
    ...
    */
     ...
     */
    'cmpTemplates' => array (
         'mgr:<div id="resourcealert-panel-home-div"></div>',
    ),
    /* *******************************************
